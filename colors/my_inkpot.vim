...
" Edited by Michel Albert -- removed string background color
...
if has("gui_running")
    ...
    hi Search         gui=NONE   guifg=#aaaadd   guibg=#333366
    ...
    hi String         gui=NONE   guifg=#8fbf6d   guibg=NONE
    ...
    hi SignColumn     gui=BOLD   guifg=#ffcd00   guibg=NONE
